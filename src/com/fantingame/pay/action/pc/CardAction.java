...
public class CardAction extends BaseAction{
	...
	public String execute() {
		try {
			...
			payTrade      = getTradeByInvoice(invoice);
			PayEb payEb   = newPayEbOrder(invoice,channel.getId(),Constants.isTest?payTrade.getReqFee():cardAmt,"卡号:"+cardNumber);//创建充值订单
			...
			}else if(Constants.CHANNEL_ID_99BILL == channel.getParentId()){//快钱-手机卡支付
