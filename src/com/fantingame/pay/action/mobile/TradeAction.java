...
public class TradeAction extends BaseAction{
	...
	private Integer paySort = 2;
	
	public String execute() throws Exception {
		try{
			//假如不是App访问，则跳到WAP的请求地址去
			if(isEasouHallApp()) return "trade_wap";
	...
	private Map<String,String> verifyParams() throws Exception{
        ...
        StringTools.setValue(map,Constants.FIELD_REDIRECT_URL,getParam(Constants.FIELD_REDIRECT_URL),255,false,false);
