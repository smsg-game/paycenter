...
public class CardAction extends ECenterBaseAction{
...
//			}
			...
			payTrade = getTradeByInvoice(invoice);
			PayEb payEb = newPayEbOrder(invoice , channel.getId(),cardAmt,"卡号:"+cardNumber); 
...
//				cardAmt = "0.1";
//			}
			PayTrade trade = newChargeTrade(cardAmt,backUrl,"module",invoiceId);
