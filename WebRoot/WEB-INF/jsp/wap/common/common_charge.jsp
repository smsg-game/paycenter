...
<ul class="payMode">
    ...
    <a href="/wap/charge!selectAmount.e?type=select_amount_sms&channelId=<%=Constants.CHANNEL_ID_SMSYHXF%>">
		<li class="msg">
	...
	<a href="/wap/charge!selectAmount.e?type=select_amount_mo9&channelId=<%=Constants.CHANNEL_ID_MO9%>">
		<li class="mo9">
			<span class="pic"><span></span></span>
	...
	<a href="/wap/charge!selectAmount.e?type=select_amount_ali&channelId=<%=Constants.CHANNEL_ID_ALIPAY_WAP%>">
		<li class="alipay">
			<span class="pic"><span></span></span>
	...
	<a href="/wap/charge!selectAmount.e?type=select_amount_phonecard">
		<li class="tel">
			<span class="pic"><span></span></span>
	...
	<a href="/wap/charge!selectAmount.e?type=select_amount_gamecard">
		<li class="play">
			<span class="pic"><span></span></span>
	...
	<a href="/wap/charge!selectAmount.e?type=select_amount_qqcard">
		<li class="qqbi">
			<span class="pic"><span></span></span>
