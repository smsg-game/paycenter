...
<div>
	...
	<div class="mode">
		...
		<div>
			...
			<div class="gayText">
				手机号：<input id="phoneNum" class="loginInput" name="phoneNum" type="text" placeholder="请输入您的手机号" value="${phoneNo}"/>
			</div>
		</div>
...
$(document).ready(function(){
	...
	$("#ok").live("click touchStart",function(){
	    if(verify()){
	       location.href= "/wap/smsYhxf.e?money="+money.val()+"&phoneNum="+phoneNum.val()+"&invoice="+$("#invoice").val();
	    } 
	})
