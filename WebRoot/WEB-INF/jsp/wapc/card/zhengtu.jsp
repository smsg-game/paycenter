	...
	<div class="tel-mode"><div id="menu">
		...
		<div class="tel-money">
			 <form action="card.e"  method="get">
				...
				<input type="hidden" name="channelType" value="8"/>
				...
				<div>
					...
					<span class="radio"><input type="radio" name="cardAmt" value="250" />250元</span>
			...
			<h6>温馨提示：</h6>
			<div>
				<p  class="gayText">1、如果支付金额大于订单金额，多付的钱会自动充值到您账号的e币；<br/>2、全国官方征途游戏充值卡可用；<br />3、选择充值卡面值时，请与您的卡实际面值保持一致，以免造成充值失败和充值卡失效。</p>
			</div>
		</div>
	</div>
</div>
