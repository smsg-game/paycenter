...
<div class="mode">
	...
	<div class="tel-mode"><div id="menu">
		...
		<div class="tel-money">
			...
			<h6>温馨提示：</h6>
			<div>
				<p  id="tit-3" class="gayText">1、移动充值卡支持全国卡和浙江、福建地方卡，福建卡只支持50元、100元；<br />2、选择充值卡面值时，请与您的卡实际面值保持一致，以免造成充值失败和充值卡失效。</p>
				<p  id="tit-4"  style="display:none"  class="gayText">1、联通充值卡只支持全国卡；<br />2、选择充值卡面值时，请与您的卡实际面值保持一致，以免造成充值失败和充值卡失效。</p>
				<p  id="tit-5"  style="display:none"  class="gayText">1、电信充值卡支持全国卡和广东卡，序列号第四位为“1”的卡为全国卡，为“2”的则为地方卡；<br />2、选择充值卡面值时，请与您的卡实际面值保持一致，以免造成充值失败和充值卡失效。</p>
			</div>
		</div>
