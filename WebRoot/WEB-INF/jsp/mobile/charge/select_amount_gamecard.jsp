...
<div class="mode">
	<div class="tel-mode"><div id="menu">
		...
		<div class="tel-money">
			...
			<h6>温馨提示：</h6>
			<div>
			<p  id="tit-6" class="gayText">1、请使用卡号以CSC5、CS、S、CA、CSB、YA、YB、YC、YD、80133开头的"盛大互动娱乐卡"进行支付；<br />3、选择充值卡面值时，请与您的卡实际面值保持一致，以免造成充值失败和充值卡失效。</p>
			<p  id="tit-8" style="display:none" class="gayText">1、全国官方征途游戏充值卡可用；<br />2、选择充值卡面值时，请与您的卡实际面值保持一致，以免造成充值失败和充值卡失效。</p>
			<p  id="tit-7" style="display:none"  class="gayText">1、不能使用特定游戏专属充值卡支付。 特定游戏包括大唐风云、传说、蜗牛、猫扑一卡通、九鼎、雅典娜、山河等游戏。<br />3、在此使用过的骏网一卡通，卡内剩余J点只能在易宝支付合作商家进行支付使用。</p>
	...
	ok.live("click touchStart",function(){
		...
		if(verifyCard() && passwordCard()){
			...
			if(m<am){
				...
				var commitUrl = "/mobile/card!cardCharge.e?channelType="+c+"&cardAmt="+m+"&cardNumber="+input.val()+"&cardPwd="+password.val();
				var checkUrl = "/mobile/tradeResult.e"; //往这接口取支付确切结果
				var successUrl= "/mobile/redirect!showResult.e"; //充值成功，去到首页
