...
<div class="mode-noBg">
	...
	<div>
		<br />原因：<s:property value="msg"/> 
		<br/>
		<%
		   Object obj = ServletActionContext.getValueStack((HttpServletRequest)pageContext.getRequest()).findValue("msg");
			String msg = "异常!";
			if(obj!=null){
				msg = obj.toString() ;
			}
	...
	<div class="div-blue">
		<input  class="button-blue" name="" type="button" value="返回" onclick="javascript:window.AndroidWindow.close()" />
	</div>
