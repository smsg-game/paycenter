...
<div class="mode">
	...
	现有 e 币：${eb} e币(1元=100e币) <a href="charge.e?appId=${param.appId}&backUrl=<%=URLEncoder.encode("/mobile/trade!toIndex.e")%>" class="green">充值>></a>
	</div>	
...
$(document).ready(function(){
	...
	$("#load_more").bind("click touchStart",function(){
		...
		$.getJSON("/mobile/dealHistory.e?page="+page,function(data) {
