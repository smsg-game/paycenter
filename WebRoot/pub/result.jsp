...
<link type="text/css" rel="stylesheet"  href="/css/common.css" />
  ...
  <body>
	<div class="mode-noBg">
		<div>
			<c:if test="${param.type=='ali'}">
				<c:if test="${param.code=='9000'}">
					√ 支付成功
				...
				<c:if test="${param.code!='9000'}">
					支付失败 : ${param.msg}
					<input type="hidden" id="android_com_easou_pay_code" name="android_com_easou_pay_code" value="${param.code}"/>
					<input type="hidden" id="android_com_easou_pay_msg" name="android_com_easou_pay_msg" value="${param.msg}"/>
				</c:if>
			</c:if>
